...
**Critical path:**
1. Fix P0-P6 security issues (3 hours) — see [SECURITY_AUDIT.md](SECURITY_AUDIT.md)
...
**Pre-ship checklist:** [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md)
...
**Dev Team:**
- [SECURITY_AUDIT.md](SECURITY_AUDIT.md) — P0-P6 findings, threat model
- [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md) — Pre-ship checklist
- [ARCHITECTURE.md](ARCHITECTURE.md) — Design decisions, constraints
- [DEPLOYMENT.md](DEPLOYMENT.md) — Ops, monitoring, incident runbooks
