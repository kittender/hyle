...
export async function checkInstalled(name: string, versionConstraint: string): Promise<boolean> {
  try {
...
export async function checkDeps(deps: DepEntry[] | undefined, verbose = false): Promise<boolean> {
