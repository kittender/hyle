...
- [Building](BUILDING.md) — the generic step-by-step (this page is the worked example)
- [Find & Pull](PUBLISHING_QUICKSTART.md) — consume a published blueprint
- [Configuration](../reference/CONFIG.md) — manifest field reference + patterns
- [Troubleshooting](TROUBLESHOOTING.md) — when publish or pull fails
