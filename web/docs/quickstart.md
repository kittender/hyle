...
See [quickstart-mock-data.md](quickstart-mock-data.md) for setup and details.
...
[CLI distribution](deploy/cli-distribution.md) — build npm/standalone packages.
...
[Deployment guide](deploy/production.md#environment-variables).

The CLI can be published to **npmjs** or a private registry like **Artifactory**
— see [CLI distribution](deploy/cli-distribution.md) — build npm/standalone packages.
